...
import {LuBellOff, LuBellRing, LuPalette} from "react-icons/lu";
                                    ...
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <div className="head mb-2 mt-3">
                                                <h6>You haven’{`'`}t created any job alerts yet.</h6>
                                            </div>
                                            <p>
                                                To create an alert, go to your career interests form and turn on “Job
                                                Alerts.”
                                            </p>
                                            <div className="flex justify-center">
                                                <button type="button"
