...
const Page = () => {
    ...
    const [isOptionsVisibleQuestion, setIsOptionsVisibleQuestion] = useState<boolean>(false);

    const selectBoxRefQuestion = useRef<HTMLDivElement | null>(null);

    const handleOptionClickQuestion = (option: React.SetStateAction<string>) => {
        setSelectedOptionQuestion(option);
        toggleOptionsVisibilityQuestion();
    };

    const toggleOptionsVisibilityQuestion = () => {
        setIsOptionsVisibleQuestion(!isOptionsVisibleQuestion);
    };

    useEffect(() => {
        const handleOutsideClick = (event: MouseEvent) => {
            if (selectBoxRefQuestion.current && !selectBoxRefQuestion.current.contains(event.target as Node)) {
                setIsOptionsVisibleQuestion(false);
            }
        };
    ...
    return (
        <>
            <section id="user-details-section" className="bg-[#F9FAFB] h-[100%]">
                <div className="container pt-1 pb-10">
                    <div className="mt-16 grid grid-cols-1">
                        <div className="col w-full lg:w-[800px] mx-auto">
                            {/* Job */}
                            <div className="box bg-white py-4 px-6 rounded">
                                ...
                                <div className="job_wrapper flex items-center justify-between">
                            ...
                            {/* Profile */}
                            <div className="box bg-[#E5E8EF] border border-primary py-4 px-6 mt-4 rounded">
                                <h4 className="text-[16px] text-black">
                                    Profile
                                </h4>
                            ...
                            {/* Basic Information */}
                            <div className="grid grid-cols-1 mb-4 mt-4 info-wrapper">
                                <div
                            ...
                            <div className="grid grid-cols-1 mb-4 info-wrapper">
                                <div className="col w-full py-6 px-8 bg-white rounded">
                                    ...
                                    <hr/>
                                    <h4 className="text-[14px] mt-4">Do you have any friends, relatives, or
                                        acquaintances working at Nosres?</h4>
                                    <fieldset id="radio_box" className="mt-2 flex items-center gap-6">
                                        <div
                                            className="flex items-center gap-1">
                                            <Radio
                                    ...
                                    <h4 className="text-[14px] mt-4">How did you hear about us?</h4>
                                    <div className="select-box mt-2 relative" ref={selectBoxRefQuestion}>
                                        <div className="select-option flex"
                                             onClick={toggleOptionsVisibilityQuestion}>
                                            <input type="text" placeholder="Select"
                                                   readOnly
                                                   value={selectedOptionQuestion}
                                                   className="focus:ring focus:ring-transparent focus:outline-none focus:border-gray-300 "/>
                                        </div>
                                        {isOptionsVisibleQuestion && (
                                            <div className="info-question question_content absolute w-full">
                                                <ul className="options">
                                                    <li onClick={() => handleOptionClickQuestion("Company Website")}>
                                                        Company Website
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Job Board (e.g., Indeed, Monster)")}>
                                                        Job Board (e.g., Indeed, Monster)
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Referral from a Friend or Colleague")}>
                                                        Referral from a Friend or Colleague
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Social Media (e.g., LinkedIn, Facebook)")}>
                                                        Social Media (e.g., LinkedIn, Facebook)
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Career Fair/Networking Event")}>
                                                        Career Fair/Networking Event
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Professional Association or Organization")}>
                                                        Professional Association or Organization
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Recruitment Agency")}>
                                                        Recruitment Agency
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Newspaper or Magazine Advertisement")}>
                                                        Newspaper or Magazine Advertisement
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("University/College Career Services")}>
                                                        University/College Career Services
                                                    </li>
                                                    <li onClick={() => handleOptionClickQuestion("Other")}>
                                                        Other
                                                    </li>
                                                </ul>
                                            </div>
