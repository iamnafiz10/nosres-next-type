...
import {LuBellRing, LuPalette, LuPinOff} from "react-icons/lu";
                    ...
                    <div className="mt-16 grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="col lg:col-span-7">
                            <div className="grid grid-cols-1 mb-4 info-wrapper">
                                <div className="box text-center py-6 px-8 bg-white rounded">
                                    {loading ? (
                                        <>
                                        ...
                                        <>
                                            ...
                                            <div className="head mb-2 mt-3">
                                                <h6>No new job opportunities right now.</h6>
                                            </div>
                                            <p>
                                                Currently, there are no new opportunities that fit. Don’t worry—new
                                                roles<br/> are posted frequently!
                                            </p>
                                            <div className="flex justify-center">
                                                <button type="button"
